// 大井競馬場 レースデータ & AI予想エンジン (Vercel Serverless用)
...
export function getRaceById(id) {
  ...
  if (!race) return null;
  return { ...race, date: today, venue: '大井', horses: horses[id] || [] };
}
...
export function getPrediction(raceId) {
  ...
  return { race: { ...race, date: today, venue: '大井' }, predictions, recommendations };
}
